...
L.CLASSIC_ONLY						= "WARNING: This version of " .. L.DBM .. " is only meant to be used with WoW Burning Crusade Classic. Uninstall this version and install correct version of " .. L.DBM .. " for Burning Crusade Classic WoW."
