...
DBM = {
	...
	DisplayVersion = "2.5.2 alpha", -- the string that is shown as version
	ReleaseRevision = releaseDate(2021, 4, 1, 1) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
...
do
	function loadOptions(self)
		...
		if WOW_PROJECT_ID ~= WOW_PROJECT_BURNING_CRUSADE_CLASSIC then return end--Don't do sound migration in a situation user is loading wrong DBM version, to avoid sound path corruption
